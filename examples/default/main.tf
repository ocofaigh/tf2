...
module "resource_group" {
  source = "git::https://github.ibm.com/GoldenEye/resource-group-module.git?ref=1.1.0"
...
module "acl_profile" {
  source = "git::https://github.ibm.com/GoldenEye/acl-profile-ocp.git?ref=1.1.1"
}
...
module "vpc" {
  source            = "git::https://github.ibm.com/GoldenEye/vpc-module.git?ref=2.3.2"
...
module "observability_instances" {
  source                     = "git::https://github.ibm.com/GoldenEye/observability-instances-module?ref=4.2.1"
  region                     = var.region
  resource_group_id          = module.resource_group.resource_group_id
...
module "service_mesh_profiles" {
  source              = "git::https://github.ibm.com/GoldenEye/ocp-service-mesh-module.git//ocp-service-mesh-profiles?ref=1.17.1"
